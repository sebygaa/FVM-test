...
os.makedirs('results_still', exist_ok=True)
...
graph_t(P_ov, z_dom, t_sample, ii_arr, 
        'Pressure (bar)', 
        'results_still/res_P_profile.png', 
        bbox_pos = (1.42, 0.92))
...
graph_t(y_res[:,0*N:1*N], z_dom, t_sample, ii_arr,
        ...
        'results_still/res_C1_profile_H2.png')

# C4 Profile (CO2)
graph_t(y_res[:,3*N:4*N], z_dom, t_sample, ii_arr,
        'CO$_{2}$ Concentration (mol/m$^{3}$)', 
        'results_still/res_C4_profile_CO2.png')
...
graph_t(y_res[:,4*N:5*N], z_dom, t_sample, ii_arr,
        'H$_{2}$ uptake (mol/kg)', 
        'results_still/res_q1_profile_H2.png')
# q4 profile (CO2)
graph_t(y_res[:,7*N:8*N], z_dom, t_sample, ii_arr,
        'CO$_{2}$ uptake (mol/kg)', 
        'results_still/res_q4_profile_CO2.png')
...
def create_gif_fixed_yaxis(y_targ, z_domain, t_span, index, label, filename, 
    ...
    def update(frame_idx):
        ...
        ax.set_title(f'Profile at t = {tt:.2f} sec', 
                     fontsize=14)
        return line,
